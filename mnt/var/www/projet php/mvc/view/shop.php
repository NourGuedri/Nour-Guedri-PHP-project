...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['survey'])) {
        $listproduitdetail = $controller->listproduitparmarque($nom, $min, $max, $_POST['survey']);
    } else {
        $listproduitdetail = $controller->listproduitparprix($nom, $min, $max);
    }
} else {
    $listproduitdetail = $controller->listproduit($nom);
}
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <ul>
                                    <li>
                                        <div class="radio radio-danger">
                                            <input name="survey" id="Radios1" value="Zara" type="radio">
                                            <label for="Radios1"> Zara </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="radio radio-danger">
                                            <input name="survey" id="Radios2" value="Prada" type="radio">
                                            <label for="Radios2"> Prada </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="radio radio-danger">
                                            <input name="survey" id="Radios3" value="Versace" type="radio">
                                            <label for="Radios3"> Versace </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="radio radio-danger">
                                            <input name="survey" id="Radios4" value="Louis Vuitton" type="radio">
                                            <label for="Radios4"> Louis Vuitton </label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="radio radio-danger">
                                            <input name="survey" id="Radios5" value="Gucci" type="radio">
                                            <label for="Radios5"> Gucci </label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                    ...
                                                    <img src="<?php echo $l[7] ?>" class="img-fluid" alt="Image">
                                                    <div class="mask-icon">
                                                        <ul>
                                                        ...
                                                        <a class="cart" href="#" type='submit'>Add to Cart</a>
                                                    </div>
                                                </div>
                                                <div class="why-text">
                                                    <h4>
